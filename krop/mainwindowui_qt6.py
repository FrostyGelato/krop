...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scanQualitySelection = QtWidgets.QGroupBox(parent=self.tabBasic)
        self.scanQualitySelection.setFlat(False)
        self.scanQualitySelection.setObjectName("groupPDFOperations")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.scanQualitySelection)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.comboQuality = QtWidgets.QComboBox(parent=self.scanQualitySelection)
        self.comboQuality.setObjectName("comboQuality")
        scanQualityOptions = ["Great", "Readable", "Readable_with_dots", "Readable_with_blanks", "Numbers_look_similar", "Different_quality_columns", "Inky", "Mostly_unreadable"]
        self.comboQuality.addItems(scanQualityOptions)
        self.verticalLayout_8.addWidget(self.comboQuality)
        ...
        self.groupOtherFields = QtWidgets.QGroupBox(parent=self.tabBasic)
        self.groupOtherFields.setFlat(False)
        self.groupOtherFields.setObjectName("groupOtherFields")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.groupOtherFields)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.labelInitials = QtWidgets.QLabel(parent=self.groupOtherFields)
        self.labelInitials.setObjectName("labelInitials")
        self.gridLayout_2.addWidget(self.labelInitials, 3, 0, 1, 1)
        ...
        self.verticalLayout_YearList = QtWidgets.QGridLayout(self.groupYearList)

        self.scrollNumbers = QtWidgets.QScrollArea(parent=self.groupYearList)
        self.scrollNumbers.setWidgetResizable(True)
        self.scrollNumbers.setMinimumHeight(200)

        self.scrollAreaNumbersContents = QtWidgets.QWidget()
        self.layoutYears = QtWidgets.QVBoxLayout(self.scrollAreaNumbersContents)
        self.layoutYears.setAlignment(QtCore.Qt.AlignmentFlag.AlignTop) # Keep numbers at the top
        ...
        self.actionPreviousPDF = QtGui.QAction(parent=MainWindow)
        self.actionPreviousPDF.setObjectName("actionPreviousPDF")
        self.actionNextPDF = QtGui.QAction(parent=MainWindow)
        self.actionNextPDF.setObjectName("actionNextPDF")
        ...
        self.toolBar.addAction(self.actionPreviousPDF)
        self.toolBar.addAction(self.actionNextPDF)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupOtherFields.setTitle(_translate("MainWindow", "Other Information"))
        self.labelInitials.setToolTip(_translate("MainWindow", "<p>Enter your initials.</p>"))
        self.labelInitials.setText(_translate("MainWindow", "RA Initials:"))
        self.editInitials.setToolTip(_translate("MainWindow", "<p>Enter your initials.</p>"))
...
"<br><a href=\'https://arminstraub.com\'>https://arminstraub.com</a></p>"))
        ...
        self.actionPreviousPage.setShortcut(_translate("MainWindow", "Shift+Up"))
        self.actionNextPage.setText(_translate("MainWindow", "Next Page"))
        self.actionNextPage.setShortcut(_translate("MainWindow", "Shift+Down"))
        ...
        self.actionPreviousPDF.setText(_translate("MainWindow", "Previous PDF"))
        self.actionPreviousPDF.setShortcut(_translate("MainWindow", "Shift+Left"))
        self.actionNextPDF.setText(_translate("MainWindow", "Next PDF"))
        self.actionNextPDF.setShortcut(_translate("MainWindow", "Shift+Right"))
